...
<div id="vote-content">
    ...
    <input type="button" class="default-button" name="AddVote" value="<?=erTranslationClassLhTranslation::getInstance()->getTranslation('gallery/image','Like it!')?> | <?=$image->votes?>" onclick="hw.vote(<?=$image->pid?>,1)"/>
</div>
</div>